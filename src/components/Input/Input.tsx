        ...
        <div>
            <input
                ...
                className={twMerge('py-4 px-5 text-base rounded-sm bg-white/50 border-b-2 border-transparent outline-none ' +
                    ...
                    'peer', className)}
            />
            <label className='text-xs font-bold block ml-5 mt-2  transition-all duration-400 peer-placeholder-shown:-translate-y-16 peer-placeholder-shown:opacity-0 peer-placeholder-shown:invisible
